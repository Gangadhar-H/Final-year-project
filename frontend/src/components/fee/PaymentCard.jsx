...
const PaymentCard = ({ feeStructure, paymentStatus, paymentDetails, onPayNow, onViewReceipt }) => {
                    ...
                    <button
                        onClick={() => {
                            if (paymentDetails?.receiptNumber) {
                                // Use the passed onViewReceipt function
                                onViewReceipt(paymentDetails.receiptNumber);
                            }
                        }}
